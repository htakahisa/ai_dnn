...
from learning_attacker_escort import LearningAttackerEscortController, SITE_APPROACH_DIST_THRESHOLD
...
class MultiRoleAttackerController(BaseController):
    ...
    def __init__(
        self,
        carry_model_path="data_temp/attacker_carry_data/dqn_attacker_carry_best_by_eval.pt",
        escort_model_path="data_temp/attacker_escort_data/dqn_attacker_escort_best_by_eval.pt",
        retrieve_model_path="data_temp/attacker_retrieve_data/dqn_attacker_retrieve_best_by_eval.pt",
        guard_model_path="data_temp/attacker_guard_data/dqn_attacker_guard_best_by_eval.pt",
        greedy=False,
    ):
        super().__init__()
