...
CHARACTER_TABLE: Dict[str, CharacterStats] = {
    "Chronicle": CharacterStats(
        "Chronicle", 0.35, 0.23, 105, 0.78, 135, "フラッシュ", 80
    ),
    "Demon1": CharacterStats("Demon1", 0.5, 0.13, 80, 0.85, 145, "スモーカー", 150),
    ...
    "Flashback": CharacterStats(
        "Flashback", 0.38, 0.22, 79, 0.77, 130, "フラッシュ", 70
    ),
    ...
    "SugarZ3ro": CharacterStats(
        "SugarZ3ro", 0.29, 0.18, 120, 0.65, 93, "スモーカー", 40
    ),
    ...
    "Rossy": CharacterStats("Rossy", 0.31, 0.18, 89, 0.7, 100, "シーカー", 50),
    ...
    "FNS": CharacterStats("FNS", 0.17, 0.13, 170, 0.63, 70, "スモーカー", 40),
