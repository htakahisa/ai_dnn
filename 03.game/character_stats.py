...
CHARACTER_TABLE: Dict[str, CharacterStats] = {
    ...
    "ねこさん": CharacterStats("ねこさん",0.4,0.3,80,0.75,150,"スモーカー",50,9),
    "いぬさん": CharacterStats("いぬさん",0.3,0.25,80,0.85,130,"フラッシュ",50,4),
    "とりさん": CharacterStats("とりさん",0.45,0.5,80,0.7,155,"シーカー",50,7),
    "ひつじさん": CharacterStats("ひつじさん",0.35,0.2,135,0.9,135,"スモーカー",50,5),
