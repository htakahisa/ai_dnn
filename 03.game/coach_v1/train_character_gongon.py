"""Train the gongon character model from actor-safe labeled examples."""
...
def train_gongon(
    ...
    *,
    ...
    trainer = CharacterTrainer(1, seed=seed, config=config, learning_rate=learning_rate, directory=directory)
    if resume:
        trainer.resume()
