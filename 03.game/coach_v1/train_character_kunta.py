"""Train the kunta character model from actor-safe labeled examples."""
...
def train_kunta(
    ...
    *,
    ...
    trainer = CharacterTrainer(3, seed=seed, config=config, learning_rate=learning_rate, directory=directory)
    if resume:
        trainer.resume()
