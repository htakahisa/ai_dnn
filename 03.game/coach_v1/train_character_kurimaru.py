"""Train the kurimaru character model from actor-safe labeled examples."""
...
def train_kurimaru(
    ...
    *,
    ...
    trainer = CharacterTrainer(4, seed=seed, config=config, learning_rate=learning_rate, directory=directory)
    if resume:
        trainer.resume()
