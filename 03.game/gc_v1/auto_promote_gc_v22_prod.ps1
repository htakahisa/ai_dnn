<#
.AutoPromote GC v22 Production Script
...
# 学習済みv22モデルのソースパス（最新の学習ディレクトリに修正）
$V22_SOURCE_DIR = "D:\git\ai_dnn\03.game\gc_v1\data\attacker_gc_escort_support_current/training"
...
# コードベースの公式評価基準（select_gc_carry_movement_v22.py から引用）
