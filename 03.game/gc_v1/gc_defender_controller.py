...
from learning_defender_retake_gc import LearningDefenderRetakeGCController
from learning_defender_search_gc import LearningDefenderSearchGCController


class GCDefenderController(BaseController):
...
# 旧run_game設定との互換用
TouyamaDefenderController = GCDefenderController
