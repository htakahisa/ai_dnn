param(
    [string]$InputDir = (Join-Path $PSScriptRoot "data\attacker_gc_curriculum_v10"),
    [string]$OutputDir = ""
)
...
if ([string]::IsNullOrWhiteSpace($OutputDir)) {
    $OutputDir = Join-Path $PSScriptRoot "data\attacker_gc_curriculum_v10_resume_$episodeOffset"
}
...
& "D:\git\python\python.exe" -X utf8 $gcTrainer `
    ...
    --episodes $remainingEpisodes --curriculum-episodes 1000 --navigation-bootstrap-episodes 1000 `
