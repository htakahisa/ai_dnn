param(
    [string]$InputDir = (Join-Path $PSScriptRoot "data\attacker_gc_curriculum_v12"),
    [string]$OutputDir = ""
)
...
if ([string]::IsNullOrWhiteSpace($OutputDir)) {
    $OutputDir = Join-Path $PSScriptRoot "data\attacker_gc_curriculum_v12_resume_$episodeOffset"
}
