param(
    [string]$OutputDir = (Join-Path $PSScriptRoot "data\attacker_gc_curriculum_v7")
)

$gcInitDir = Join-Path $PSScriptRoot "data\attacker_gc_curriculum_v6_resume_750"
...
if ([int]$gcBundle.episode -ne 750) {
    throw "Expected the preserved episode 750 best checkpoint, got episode $($gcBundle.episode)"
}
...
& "D:\git\python\python.exe" -X utf8 $gcTrainer `
    ...
    --start-stats 50 10 0 --final-stats 100 60 40 --seed 2026093000 `
