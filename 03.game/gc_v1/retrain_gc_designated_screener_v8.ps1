param(
    [string]$OutputDir = (Join-Path $PSScriptRoot "data\attacker_gc_curriculum_v8")
)
...
if ([int]$gcBundle.episode -ne 750) {
    throw "Expected the preserved v6 episode 750 checkpoint, got episode $($gcBundle.episode)"
}
...
& "D:\git\python\python.exe" -X utf8 $gcTrainer `
    ...
    --start-stats 50 10 0 --final-stats 100 60 40 --seed 2026094000 `
