param(
    [string]$OutputDir = (Join-Path $PSScriptRoot "data\attacker_gc_curriculum_v14")
)

$gcInitDir = Join-Path $PSScriptRoot "data\attacker_gc_curriculum_v12"
...
if ([int]$gcBundle.episode -ne 0) {
    throw "Expected the preserved v12 episode 0 checkpoint, got episode $($gcBundle.episode)"
}
...
& "D:\git\python\python.exe" -X utf8 $gcTrainer `
    ...
    --start-stats 50 10 0 --final-stats 100 60 40 --seed 2026100000 `
