...
class MacroEnv:
    ...
    def _update_tactical_history(self):
        ...
        inferred_a_to_b = (
            rotate_decision is not None
            and rotate_decision["source"] == "INFERRED"
            and rotate_decision["direction"] == "A_TO_B"
        )
        inferred_b_to_a = (
            rotate_decision is not None
        ...
        # --------------------------------------------------------------
        if self.current_strategy == "ROTATE_A_TO_B" and (
            (a_heavy and b_light) or inferred_a_to_b
        ):
        ...
        elif self.current_strategy == "ROTATE_B_TO_A" and (
            (b_heavy and a_light) or inferred_b_to_a
        ):
            if not self._smart_rotate_completed:
                if inferred_b_to_a:
                    self._diag_rotate_completed_inferred += 1
...
def main():
    ...
    print("=" * 78)
    print("Ghost Champions - Attacker Macro DQN Training v25")
    print("=" * 78)
