...
class MacroEnv:
    ...
    def _create_rotate_intent_v26(self, strategy):
        """Latch DIRECT/INFERRED reason at the moment Rotate is selected."""
        ...
        expected = "A_TO_B" if strategy == "ROTATE_A_TO_B" else "B_TO_A"
...
def main():
    ...
    print("=" * 78)
    print("Ghost Champions - Attacker Macro DQN Training v27")
    print("=" * 78)
