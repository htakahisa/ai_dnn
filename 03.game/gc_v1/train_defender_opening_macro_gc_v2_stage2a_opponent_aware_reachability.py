...
MAX_ORIGIN_BFS_DISTANCE = max(1, OPENING_TICKS - 4)
...
DATA_DIR = HERE / "data" / "defender_opening_macro_gc_v2_stage2a_opponent_aware_reachability_data"
BEST = DATA_DIR / "dqn_defender_opening_macro_gc_v2_stage2a_opponent_aware_reachability_best.pt"
LATEST = DATA_DIR / "dqn_defender_opening_macro_gc_v2_stage2a_opponent_aware_reachability_latest.pt"
FINAL = DATA_DIR / "dqn_defender_opening_macro_gc_v2_stage2a_opponent_aware_reachability_final.pt"
INTERRUPT = DATA_DIR / "dqn_defender_opening_macro_gc_v2_stage2a_opponent_aware_reachability_interrupt.pt"
...
# global 10 + opponent 10 + players 5*8 + plans 5*8
OBS_DIM = 100
...
def build_obs(game, plans, tick):
    ...
    obs=np.asarray(g+opp+pf+pl,np.float32)
