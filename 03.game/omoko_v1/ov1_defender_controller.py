...
from ov1_learning_defender_retake import Ov1LearningDefenderRetakeController
from ov1_learning_defender_search import Ov1LearningDefenderSearchController


class Ov1DefenderController(BaseController):
    ...
    def __init__(
        self,
        search_model_path="omoko_v1/data/defender_search_data/dqn_defender_search_best_by_eval.pt",
        retake_model_path="omoko_v1/data/defender_retake_data/dqn_defender_retake_best_by_eval.pt",
        greedy=True,
    ):
        super().__init__()
        self.search_controller = Ov1LearningDefenderSearchController(
            model_path=search_model_path, greedy=greedy
        )
        self.retake_controller = Ov1LearningDefenderRetakeController(
