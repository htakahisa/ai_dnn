...
class TouyamaDefenderController(BaseController):
    ...
    def __init__(
        self,
        search_model_path="touyama_v1/data/defender_search_touyama_data/dqn_defender_search_touyama_best_by_eval.pt",
        retake_model_path="touyama_v1/data/defender_retake_touyama_data/dqn_defender_retake_touyama_best_by_eval.pt",
        greedy=True,
    ):
        super().__init__()
