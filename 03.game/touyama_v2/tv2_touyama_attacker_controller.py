...
from tv2_learning_attacker_carry_touyama import LearningAttackerCarryTouyamaController
from tv2_learning_attacker_escort_touyama import LearningAttackerEscortTouyamaController
from tv2_learning_attacker_retrieve_touyama import LearningAttackerRetrieveTouyamaController
from tv2_learning_attacker_guard_touyama import LearningAttackerGuardTouyamaController


class Tv2TouyamaAttackerController(BaseController):
    ...
    def __init__(
        self,
        carry_model_path="touyama_v2/data/attacker_carry_touyama_data/dqn_attacker_carry_touyama_best_by_eval.pt",
        escort_model_path="touyama_v2/data/attacker_escort_touyama_data/dqn_attacker_escort_touyama_best_by_eval.pt",
