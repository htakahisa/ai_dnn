"""AI Ver5 Flash: Smoke学習済み方策を引き継ぎ、Flash行動を学習する1vs2環境。
...
実行例:
    python train_attacker_ai_v5_flash.py --episodes 1000 --smoke-model attacker_ai_v4_smoke_v2_data/dqn_attacker_ai_v4_smoke_v2_best.pt
    python train_attacker_ai_v5_flash.py --resume attacker_ai_v5_flash_data/training_state_latest.pt
    python train_attacker_ai_v5_flash.py --smoke-model attacker_ai_v4_smoke_v2_data/dqn_attacker_ai_v4_smoke_v2_best.pt --eval
"""
...
MODEL_DIR = BASE_DIR / "attacker_ai_v5_flash_data"
LATEST_MODEL_PATH = MODEL_DIR / "dqn_attacker_ai_v5_flash_latest.pt"
BEST_MODEL_PATH = MODEL_DIR / "dqn_attacker_ai_v5_flash_best.pt"
FINAL_MODEL_PATH = MODEL_DIR / "dqn_attacker_ai_v5_flash_final.pt"
...
class DuelingQNetwork(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # Flash HeadはAbility 6..13だけを補正する。MOVE/WAIT/PLANTのQ値は不変。
        return torch.cat(
            [base_q[..., :6], base_q[..., 6:14] + ability_delta],
            dim=-1,
        )
