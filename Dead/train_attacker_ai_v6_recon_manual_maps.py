...
実行例:
    ...
    python train_attacker_ai_v6_recon_manual_maps.py --flash-model attacker_ai_v5_flash_v2_data/dqn_attacker_ai_v5_flash_v2_best.pt --eval --eval-q-trace-steps 30
"""
...
def evaluate(
    ...
    for episode in range(1, episodes + 1):
        ...
        while not done:
            ...
            if episode == 1 and recon_debug_before_step is not None:
                recon_debug_before_step.update(
                    {
